Contributing to SlicerMatter
===============================

There are many ways to contribute to SlicerMatter.

  * Submit a feature request or bug, or add to the discussion on the [SlicerMatter issue tracker][is]
  * Submit a [Pull Request][pr] to improve SlicerMatter.
...
If you are new to SlicerMatter development and you don't have push access to the SlicerMatter
...
When submitting a PR, make sure to add a `Cc: @SlicerMatter/developers` comment to
notify SlicerMatter developers of your awesome contributions. Based on the
...
* You do NOT have push access: A SlicerMatter core developer will integrate your PR.
...
[pr]: https://github.com/phcerdan/SlicerMatter/merge_requests
[is]: https://github.com/phcerdan/SlicerMatter/issues
